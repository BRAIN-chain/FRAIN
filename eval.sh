...
for i in $(seq 1 10); do
    ...
    for IID in ${IIDS[@]}; do
        ...
        CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=0  --score_byzantines=0  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=0  --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0
        ...
        CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=10 --score_byzantines=0  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=0  --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0
        ...
        CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=5  --score_byzantines=5  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=0  --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0
        ...
        CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=0  --score_byzantines=0  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=11 --interpol=lerp  --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0
        ...
        # CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=0  --score_byzantines=0  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=0  --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0  # FRAIN
        ...
        CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=0  --score_byzantines=0  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=5  --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0  # FRAIN
        CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=0  --score_byzantines=0  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=11 --interpol=lerp  --adaptive=constant  # BRAIN
        # CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=0  --score_byzantines=0  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=11 --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0  # FRAIN
        ...
        CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=0  --score_byzantines=0  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=15 --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0  # FRAIN
        ...
        CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=0  --score_byzantines=0  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=21 --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0  # FRAIN
        ## FRAIN, with 5 Distruptors (with 5 Nullifiers)
        # CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=5  --score_byzantines=5  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=0  --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0
        CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=5  --score_byzantines=5  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=5  --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0
        CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=5  --score_byzantines=5  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=11 --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0
        CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=5  --score_byzantines=5  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=15 --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0
        CUDA_VISIBLE_DEVICES=${DEVICE} PYTHONPATH=$(pwd) python src/FRAIN.py    --iid=${IID} --epochs=200 --byzantines=5  --score_byzantines=5  --frac=0.1 --stale=16 --diff=0.55 --window=4 --threshold=0.2 --verbose=0 --drift=21 --interpol=slerp --adaptive=hinge --adaptive_a=10.0 --adaptive_b=4.0 --adaptive_c=16.0
