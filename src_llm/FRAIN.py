...
if __name__ == '__main__':
    ...
    # Saving the objects:
    file_name = './save_llm/objects/frain_{}_C{}_iid{}_E{}_B{}_Z{}_SZ{}_D{}_W{}_S{}_TH{}_DR{}_{}_{}_a{}_b{}_c{}_{}.pkl'.\
        format(
    ...
    plt.savefig(
        './save_llm/frain_{}_C{}_iid{}_E{}_B{}_Z{}_SZ{}_D{}_W{}_S{}_TH{}_DR{}_{}_{}_a{}_b{}_c{}_ppl.png'.
        format(
            args.epochs, args.frac, args.iid,
            args.local_ep, args.local_bs, args.byzantines, args.score_byzantines,
            args.diff, args.window, args.stale, args.threshold,
