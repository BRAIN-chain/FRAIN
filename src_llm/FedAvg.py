...
if __name__ == '__main__':
    ...
    for epoch in range(args.epochs):
        ...
        try:
            ...
            global_weights = compose_weight(
                local_weights[0], local_weights[1], a=0.5)  # TODO: now only treating len==2 case, why `average_weights` not working?
    ...
    # Saving the objects:
    file_name = './save_llm/objects/fedavg_{}_C{}_iid{}_E{}_B{}_Z{}_{}.pkl'.\
    ...
    plt.savefig('./save_llm/fedavg_{}_C{}_iid{}_E{}_B{}_Z{}_ppl.png'.
                format(args.epochs, args.frac, args.iid,
